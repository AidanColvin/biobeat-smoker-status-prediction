...
## orchestrator: runs all feature analysis steps in order
## expects train_clean from preprocessing pipeline
## passes predictor_weights to models/run_all_models.R
...
message("feature analysis complete — passing predictor_weights to models")
